...
// Returns true if response is a valid Reverse HTTP upgrade Request
// (i.e. a valid HTTP/1.1 protocol upgrade request where the Upgrade Header
// is "PTTH/1.0).
// This function will return False otherwise, including when req is nil.
...
// Produces an http.Client from an http.ResponseWriter and http.Request.
